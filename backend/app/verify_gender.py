...
def classify_gender_from_face(face_region):
    """
    Lightweight gender classification based on facial image heuristics.
    This should be treated as an approximate signal, not a definitive identity claim.
    """
    ...
    if lower_brightness < upper_brightness - 8:
        score += 1
