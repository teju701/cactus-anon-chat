  ...
  return (
    <div className="page-container">
      <div className="card">
        ...
        {status && (
          <div className={`alert ${status.startsWith("✓") ? "alert-success" : status.startsWith("❌") ? "alert-error" : "alert-info"}`}>
            {status}
          </div>
        )}

        <div className="alert alert-warning" style={{ marginTop: "1rem" }}>
          <p className="text-tiny">🔒 Image is analyzed in real time and immediately deleted.</p>
        </div>
      </div>
    </div>
  );
